...
public class MatchaConnection {
    ...
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = MatchaConnection.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
     ...
     */
    public List<List<Object>> getSheetValues(String sheetName) throws IOException, GeneralSecurityException {
        // Build a new authorized API client service.
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
        final String spreadsheetId = "1-N7TbXF8uRarDqnR3o44vqmMC1zlHfcxTich7VXYT2k";
        final String range = sheetName+"!A2:K";
